...
<xsl:template match="/">
   ...
   <xsl:if test="$version = $latest-version">
      ...
      <xsl:call-template name="new-page">
         ...
         <xsl:with-param name="title">
            ...
            <xsl:text> - Developer Page</xsl:text>
         </xsl:with-param>
         <xsl:with-param name="menu">
            <xsl:call-template name="menu">
               <xsl:with-param name="module" select="$module" />
   ...
   <exsl:document href="update.bat" method="text">
      ...
      <xsl:text />wzzip -o <xsl:value-of select="$module" />.zip @<xsl:value-of select="$module" />.package.txt&#xA;<xsl:text />
      <xsl:text>cd ..&#xA;</xsl:text>
      ...
      <xsl:text />cd <xsl:value-of select="$etype" /><xsl:text>&#xA;</xsl:text>
      <xsl:text />cd <xsl:value-of select="$extension" /><xsl:text>&#xA;</xsl:text>
   </exsl:document>
</xsl:template>
